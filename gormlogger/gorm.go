...
func NewDefault(l logger.Logger) gormlogger.Interface {
    return NewGormLogger(context.Background(), l, 5*time.Second)
}

// Logger return singleton logger
func NewGormLogger(ctx context.Context, log logger.Logger, slowThreshold time.Duration) gormlogger.Interface {
